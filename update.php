...
$good = mysqli_fetch_assoc($good); //немного другое чем mysqli_fetch_all. Преобразует, как я понял всё в массив(?)
?>
...
<body>
    ...
    <form action="vendor/update.php" method="post">
        <input type="hidden" name="id" value="<?= $goods_id ?>"> <!-- инпут, который нужен для обработки формы АПДЕЙТА(хранит id, для того чтобы потом его передать в АПДЕЙТ) -->
        <p>Название</p>
